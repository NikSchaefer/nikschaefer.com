			...
			<div className="pt-12 border-t dark:border-gray-700">
				<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
					<div className="flex flex-col text-center">
						...
						<p className="dark:text-gray-400">
							...
							student, and open source enthusiast. You've found my
							personal slice of the internet. Learn more about me
							or get in touch while your here.
						</p>
					</div>
				</div>
				<div className="flex justify-center pt-4 space-x-4 align-center">
					<a
						...
						className="p-2 rounded-md dark:text-gray-100 dark:hover:text-purple-400"
					>
						<svg
							viewBox="0 0 496 512"
