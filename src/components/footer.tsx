...
function Column({ col }: { col: ColType[] }) {
	return (
...
function Socials(): JSX.Element {
	return (
		<div className="flex items-center justify-between max-w-[300px] pt-8 mx-auto border-t border-gray-200">
			<a href={socials.github.link} aria-label={socials.github.name}>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="currentColor"
					className="w-6 h-6 text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
			...
			<a href={socials.email.link} aria-label={socials.email.name}>
				<svg
					viewBox="0 0 512 512"
					xmlns="http://www.w3.org/2000/svg"
					className="w-6 h-6 text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
			...
			<a href={socials.linkedin.link} aria-label={socials.linkedin.name}>
				<svg
					fill="currentColor"
					className="w-6 h-6 text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white"
					viewBox="0 0 1792 1792"
